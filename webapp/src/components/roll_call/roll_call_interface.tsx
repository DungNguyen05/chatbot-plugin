...
const translations: Record<'en' | 'vi', Record<string, string>> = {
    ...
    vi: {
        ...
        'rollcall.checkin.title': 'Vào Làm',
        'rollcall.checkout.title': 'Tan Ca',
        'rollcall.absent.title': 'Báo Vắng',
        'rollcall.checkin.description': 'Đánh dấu giờ vào làm',
        'rollcall.checkout.description': 'Đánh dấu giờ tan ca',
